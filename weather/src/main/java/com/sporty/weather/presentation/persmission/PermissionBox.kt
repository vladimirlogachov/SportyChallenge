package com.sporty.weather.presentation.persmission
 ...
 *
 * >**Note**: copied from [here](https://github.com/android/platform-samples/blob/main/shared/src/main/java/com/example/platform/shared/PermissionBox.kt)
 */
@Composable
...
internal fun PermissionBox(
    ...
    var grantedOnce by remember { mutableStateOf(false) }

    LaunchedEffect(allRequiredPermissionsGranted) {
        if (allRequiredPermissionsGranted && !grantedOnce) {
            grantedOnce = true
        }
    }
